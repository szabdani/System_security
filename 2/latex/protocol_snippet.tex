 ...
 \protocolflow{1.5}{0.75}{ 
	 ...
	 \package{5,-2}{0,-2}{$\{ K_{AB}, ID_B, N_A, \{K_{AB}, ID_A\}_{K_{BS}}\}_{K_{AS}}$} \package{0,-3}{5,-3}{$\{ K_{AB}, ID_A \}_{K_{BS}}$} 
	 \package{10,-4}{0,-4}{$\{ N_B \}_{K_{AB}}$} 
	 \package{0,-5}{10,-5}{$\{ 2 * N_B + 5 \}_{K_{AB}}$} 
 } 
 \end{document}
